...
def r2_score_evaluate_function(**kwargs):
...
def mean_absolute_percente_error_optimization_function(**kwargs):
    data: pd.DataFrame = kwargs.get('data')
    target: str = kwargs.get('target')
    params = kwargs.get('params', None)
    model = kwargs.get('model')
...
def mean_absolute_error_optimization_function(**kwargs):
    data: pd.DataFrame = kwargs.get('data')
    target: str = kwargs.get('target')
    params = kwargs.get('params', None)
    model = kwargs.get('model')
