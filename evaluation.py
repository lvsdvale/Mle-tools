...
class ClassifierEvaluator:
    def __init__(
        self, data: pd.DataFrame, target_column: str, models: list, kfold=True
    ):
        self.__data: pd.DataFrame = data
        self.__target_columns: str = target_column
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "f1 Score"])
                )
        else:
    ...
    def recall_score_evaluation(self, n_splits: int = 0) -> pd.DataFrame:
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                score = np.mean(scores)
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "recall Score"])
                )
        else:
            x_train, x_test, y_train, y_test = train_test_split(
                x, y, test_size=0.30, random_state=42
    ...
    def precision_score_evaluation(self, n_splits: int = 0) -> pd.DataFrame:
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                score = np.mean(scores)
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "precision Score"])
                )
        else:
            x_train, x_test, y_train, y_test = train_test_split(
                x, y, test_size=0.30, random_state=42
    ...
    def accuracy_score_evaluation(self, n_splits: int = 0) -> pd.DataFrame:
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                score = np.mean(scores)
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "accuracy Score"])
                )
        else:
            x_train, x_test, y_train, y_test = train_test_split(
                x, y, test_size=0.30, random_state=42
    ...
    def r2_score_evaluation(self, n_splits: int = 0) -> pd.DataFrame:
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                score = np.mean(scores)
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "R2 Score"])
                )
        else:
            x_train, x_test, y_train, y_test = train_test_split(
                x, y, test_size=0.30, random_state=42
    ...
    def adjusted_r2_score_evaluation(self, n_splits: int = 0) -> pd.DataFrame:
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                score = np.mean(scores)
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "Adjusted R2 Score"])
                )
        else:
            x_train, x_test, y_train, y_test = train_test_split(
                x, y, test_size=0.30, random_state=42
    ...
    def mean_absolute_percentage_error_evaluation(self, n_splits: int = 0):
        ...
        if n_splits != 0:
            ...
            for model in models:
                ...
                score = np.mean(scores)
                list_of_series.append(
                    pd.Series([model, score], index=["Model", "MAPE"])
                )
        else:
            x_train, x_test, y_train, y_test = train_test_split(
                x, y, test_size=0.30, random_state=42
